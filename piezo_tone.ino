...
void setup() {
	pinMode(0, OUTPUT); // We use pins 0 and 1 as differential outputs for the piezo buzzer
	pinMode(1, OUTPUT); // this offers improved loudness compared to a single pin
